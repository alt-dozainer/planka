...
export default {
  ...
  format: {
    ...
    longDate: 'd MMM',
    longDateTime: "d MMMM 'la' p",
    fullDate: 'd MMM y',
    fullDateTime: "d MMMM y 'la' p",
  },
  ...
  translation: {
    common: {
      ...
      linkIsCopied: 'Link-ul s-a copiat',
      list: 'Lista',
      listActions_title: 'Listează acțiuni',
      managers: 'Managerii',
      members: 'Responsabili',
      minutes: 'Minute',
    ...
    action: {
      ...
      addMoreDetailedDescription: 'Adăugați descrierea mai detaliată',
      addTask: 'Adăugați sarcină',
      addToCard: 'Adauga în card',
      addUser: 'Adăugați utilizator',
      copyLink_title: 'Copiați Link',
